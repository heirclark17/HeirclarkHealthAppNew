  ...
  return (
    <>
      <TouchableOpacity
        ...
        onPress={handlePress}
        style={{ flex: 1 }}
        accessibilityLabel={`Protein intake: ${Math.round(current)} grams of ${goal} gram goal, ${percentage.toFixed(0)}% complete`}
        accessibilityRole="button"
        accessibilityHint="Opens detailed view with protein information and importance for muscle building and satiety"
      >
      ...
      >
        <TouchableOpacity
          ...
          accessibilityLabel="Close protein detail modal"
          accessibilityRole="button"
          accessibilityHint="Dismisses the protein information view and returns to the main screen"
        >
          <Animated.View
