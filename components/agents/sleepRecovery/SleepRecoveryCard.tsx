...
const styles = StyleSheet.create({
  ...
  logButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 16, borderRadius: 10, marginBottom: 12 },
  ...
  input: { padding: 16, borderRadius: 10, fontSize: 16, fontFamily: Fonts.regular, borderWidth: 1 },
