...
const styles = StyleSheet.create({
  ...
  dailyTipCard: { padding: 16, borderRadius: 12, marginBottom: 12 },
  ...
  recommendedCard: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, marginRight: 8, minWidth: 100 },
  ...
  mistakeItem: { padding: 12, borderRadius: 12, marginBottom: 8 },
  mistakeHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
