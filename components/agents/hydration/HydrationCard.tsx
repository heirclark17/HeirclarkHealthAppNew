        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <View style={[styles.iconContainer, { backgroundColor: colors.accentCyan + '20' }]}>
              <Ionicons name="water" size={26} color={colors.accentCyan} />
            </View>
            <View>
...
const styles = StyleSheet.create({
  ...
  progressBarContainer: { height: 10, borderRadius: 4, overflow: 'hidden', marginBottom: 12 },
  ...
  entryItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 12, borderRadius: 12, marginBottom: 8 },
  ...
  miniProgressBar: { width: 60, height: 6, borderRadius: 4, overflow: 'hidden' },
