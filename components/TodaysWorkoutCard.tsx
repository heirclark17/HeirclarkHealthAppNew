...
const WORKOUT_TYPE_CONFIG: Record<string, { Icon: React.ComponentType<{ size: number; color: string }>; color: string }> = {
  ...
  'Push Day': { Icon: CircleArrowUp, color: colors.protein },
  'Pull Day': { Icon: CircleArrowDown, color: 'colors.accentPurple' },
  'Full Body': { Icon: User, color: 'colors.accentCyan' },
  'Core': { Icon: Circle, color: 'Colors.errorStrong' },
  'Walking Session': { Icon: Footprints, color: Colors.success },
  'Running Session': { Icon: Footprints, color: Colors.error },
  'HIIT': { Icon: Zap, color: colors.protein },
  'Cardio': { Icon: Heart, color: 'Colors.errorStrong' },
  'Recovery': { Icon: Leaf, color: Colors.successMuted },
  'Yoga': { Icon: Leaf, color: 'colors.accentPurple' },
